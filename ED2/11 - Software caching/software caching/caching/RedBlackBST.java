...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    private Node latest;    // Último nó acessado
    ...
    ***************************************************************************/
    ...
    public Value get(Key key) {
        ...
        // Uso de caching para retornar o valor de um nó
        if (latest != null)
        {
          int cmp = key.compareTo (latest.key);
          if (cmp == 0) return latest.val;
        }

        return get(root, key);
    }

    // Valor associado a chave dada na subárvore cuja raíz é o nó x
    ...
    private Value get (Node x, Key key)
    {
      while (x != null)
      {
        ...
        {
          latest = x;     // Armazena o último nó visitado
          return x.val;
        }
      }
    ...
    ***************************************************************************/
    ...
    public void put(Key key, Value val) {
        ...
        // Uso de caching para alterar o valor de um nó
        if (latest != null)
        {
          int cmp = key.compareTo (latest.key);
          if (cmp == 0) latest.val = val;
        }
    ...
    private Node put(Node h, Key key, Value val) {
        ...
        // Armazena o nó criado que é, também, o último acessado
        if (h == null)
        {
        ...
        latest = h;   // Armazena o último nó acessado
