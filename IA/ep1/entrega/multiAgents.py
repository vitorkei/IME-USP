...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        # Imprime o mapa do jogo, com os fantasmas, pontos, pacman e paredes no terminal
        # bem como a pontuação
        successorGameState = currentGameState.generatePacmanSuccessor(action)
        
        # Retorna a posição futura do pacman
        newPos = successorGameState.getPacmanPosition()
        
        # Imprime no terminal onde as comidas estão, sendo T onde tem e F onde não tem
        # Não imprime a posição do pacman nem dos fantasmas
        newFood = successorGameState.getFood()
        
        # newGhostStates[i] retorna informações do próximo passo do fantasma
        # newGhostStates[i].getPosition() retorna a coordenada futura do fantasma
        newGhostStates = successorGameState.getGhostStates()
        
        # Retorna uma lista em que cada elemento é o tempo restante em que o fantasma
        # correspondente estará assustado
